...
const SET_CARDS = "CARDS_PACK/SET_CARDS";
const INIT_ADD_NEW_CARD_PACK = "CARDS_PACK/INIT_ADD_NEW_CARD_PACK";
const ADD_NEW_CARD_PACK = "CARDS_PACK/ADD_NEW_CARD_PACK";
const SET_LOCAL_CARD_PACK_NAME = "CARDS/SET_LOCAL_CARD_PACK_NAME";
const SET_IS_MY_TABLE = "CARDS_PACK/SET_IS_MY_TABLE";
const SET_PACK_CARD_COUNT = "CARDS_PACK/SET_PACK_CARD_COUNT";
const EDIT_CARD_PACK_NAME = "CARDS_PACK/EDIT_CARD_PACK_NAME";
const SET_CARDS_PACKS_SORT_VALUE = "CARDS_PACK/SET_CARDS_PACKS_SORT_VALUE";
const SET_IS_PRIVATE_CARD_PACK = "CARDS_PACK/SET_IS_PRIVATE_CARD_PACK";
const SET_CURRENT_PAGE = "CARDS_PACK/SET_CURRENT_PAGE";
