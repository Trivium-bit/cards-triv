...
//AC
export const setPackCardsAC = (cards:CardType[]) => ({type: SET_PACK_CARDS, cards} as const)
...
//add card thunk
export const addNewCardTC = (id: string, card: CardType, callback: () => void) =>(dispatch:AppThunkDispatch) => {
    dispatch(setAppStatusAC("loading"));
